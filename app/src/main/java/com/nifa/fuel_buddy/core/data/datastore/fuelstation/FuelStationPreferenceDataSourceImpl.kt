...
class FuelStationPreferenceDataSourceImpl @Inject constructor(
    ...
    override suspend fun setFuelStationPreferences(fuelStationPreferences: FuelStationPreferences) {
        setFuelStationEmail(fuelStationPreferences.bunkEmail)
        setFuelStationName(fuelStationPreferences.bunkName)
        setFuelStationToken(fuelStationPreferences.bunkToken)
        setFuelStationId(fuelStationPreferences.bunkId)
    }
