...
fun SetupBottomNavigation(
    ...
    onClickedBottomNavigationItem: (FuelStationBottomNavigationItem) -> Unit
) {
    ...
    AnimatedVisibility(
        ...
        NavigationBar(
            ...
            FuelStationBottomNavigationItem.entries.forEach { bottomNavigationItems ->
...
private fun SetupBottomNavigationPreview() {
    SetupBottomNavigation(
        ...
        currentDestination = FuelStationBottomNavigationItem.LIVE_ORDERS.screen::class.qualifiedName,
